...
const Header = ({ jwt, tablemap_permission, tab_permission, kitchen_permission, shift_permission }) => {
  // Navbar toggle
          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                {/* {loggedIn ? <LoggedInButtons view={view} jwt={jwt} /> : <LoggedOutButtons />} */}
                <div>
                  {/* <ThemeToggler /> */}
                </div>
              </div>
