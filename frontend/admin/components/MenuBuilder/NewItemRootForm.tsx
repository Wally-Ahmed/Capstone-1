...
interface NewItemRootFormProps {
    newItemRoot: {
        name: string;
        price: string;
        description: string;
    ...
    handleSubmitItemRoot: (e: React.FormEvent<HTMLFormElement>) => void;
    handleRootChange: (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => void;
    handleCloseItemRootForm: () => void;
}

const NewItemRootForm: React.FC<NewItemRootFormProps> = ({
    newItemRoot,
    handleSubmitItemRoot,
    handleRootChange,
    handleCloseItemRootForm,
}) => {
    return (
...
export default NewItemRootForm;
