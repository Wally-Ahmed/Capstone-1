...
const scheduleSchema_1 = __importDefault(require("./schemas/scheduleSchema"));
...
router.route('/schedule')
    ...
    .post(authenticateToken_1.authenticateAdmin, (0, validateSchema_1.validateSchema)(scheduleSchema_1.default), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { restaurant } = req;
    if (restaurant === undefined) {
        throw new expressError_1.UnauthorizedError();
    }
    ...
    const { monday_opening, tuesday_opening, wednesday_opening, thursday_opening, friday_opening, saturday_opening, sunday_opening, monday_closing, tuesday_closing, wednesday_closing, thursday_closing, friday_closing, saturday_closing, sunday_closing, time_zone, time_until_first_reservation_minutes, time_until_last_reservation_minutes, reservation_duration_minutes } = req.body;
    // Prepare the updates object
    const updates = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (monday_opening !== undefined && { monday_opening })), (tuesday_opening !== undefined && { tuesday_opening })), (wednesday_opening !== undefined && { wednesday_opening })), (thursday_opening !== undefined && { thursday_opening })), (friday_opening !== undefined && { friday_opening })), (saturday_opening !== undefined && { saturday_opening })), (sunday_opening !== undefined && { sunday_opening })), (monday_closing !== undefined && { monday_closing })), (tuesday_closing !== undefined && { tuesday_closing })), (wednesday_closing !== undefined && { wednesday_closing })), (thursday_closing !== undefined && { thursday_closing })), (friday_closing !== undefined && { friday_closing })), (saturday_closing !== undefined && { saturday_closing })), (sunday_closing !== undefined && { sunday_closing })), (time_zone !== undefined && { time_zone })), (time_until_first_reservation_minutes !== undefined && { time_until_first_reservation_minutes })), (time_until_last_reservation_minutes !== undefined && { time_until_last_reservation_minutes })), (reservation_duration_minutes !== undefined && { reservation_duration_minutes }));
    console.log(updates);
    try {
